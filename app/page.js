...
const STRINGS = {
  en: {
    ...
    heroSub:
      "Upload your logo and a photo of your actual product — Apollo returns production-grade mockups of that exact item: a clean product shot, a stitch-level close-up, and an on-model photo.",
    heroCtaPrimary: "Try the studio",
    heroCtaSecondary: "See how it works",
    heroStat1: "Your exact product",
    heroStat2: "Pick your shots",
    heroStat3: "Embroidery & screen print",
    howEyebrow: "Workflow",
    howTitle: "From file to approval in three steps",
    howSteps: [
      {
        t: "Upload logo & product",
        d: "Your logo (PNG, JPG or SVG — transparent works best) plus a clear photo of the blank product it goes on.",
      },
      {
        t: "Choose method & style",
        d: "Embroidered or screen printed, placement and size. Toggle a lifestyle scene behind the model shots.",
      },
      {
        t: "Pick shots & generate",
        d: "Select only the shots you need — product, close-up, on-model — and get client-ready images of your exact item.",
      },
    ],
  },
  zh: {
    ...
    heroTitle2: "几秒内完成渲染。",
    heroSub:
      "上传您的 Logo 和实际产品的照片，Apollo 即可生成该产品的专业级样机 —— 产品图、针脚级细节特写和模特上身图。",
    ...
    howSteps: [
      {
        t: "上传 Logo 与产品图",
        d: "您的 Logo（PNG、JPG 或 SVG —— 透明背景效果最佳），再加一张空白产品的清晰照片。",
      },
      {
        t: "选择工艺与风格",
        d: "刺绣或丝网印刷，设置 Logo 位置和大小，还可为模特上身图开启生活场景背景。",
      },
      {
        t: "选择镜头并生成",
        d: "只选您需要的镜头 —— 产品图、特写、模特上身 —— 获得您真实产品的可交付图片。",
      },
    ],
  },
};
